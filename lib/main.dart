...
class _HomePageState extends State<HomePage> {
  ...
  void _onScroll() {
    ...
    // Considere scrollOffset 0-100 para variar de transparente para opaco
          ...
          CustomScrollView(
            ...
            slivers: [
              SliverAppBar(
                ...
                elevation: _scrollOpacity * 4, // Elevação proporcional à opacidade
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      WorkoutStatsCard(
                        ...
                        chart: WeightProgressionChart(),
                      ),
                      SizedBox(height: 16),
                      WorkoutStatsCard(
                        title: 'Desempenho por Exercício',
                        chart: ExercisePerformanceChart(),
                      ),
                      SizedBox(height: 16),
                      StreakCard(streakDays: 12),
                      SizedBox(height: 16),
                      ImprovementSuggestionsCard(),
                      SizedBox(height: 80), // Espaço para a barra de navegação
                    ],
                  ),
                ),
              ),
        ...
        titlesData: FlTitlesData(
          ...
          bottomTitles: AxisTitles(
            sideTitles: SideTitles(
              ...
              reservedSize: 30,
              getTitlesWidget: (value, meta) {
                final labels = ['Sem 1', 'Sem 2', 'Sem 3', 'Sem 4', 'Sem 5', 'Sem 6', 'Sem 7'];
...
class ExerciseImproveItem extends StatelessWidget {
  ...
  const ExerciseImproveItem({super.key, 
    required this.name,
